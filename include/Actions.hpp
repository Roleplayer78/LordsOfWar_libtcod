...
#define LIMIT_FPS  10  // Frames-per-second - one second real time 
...
#define AP_COST_MOVE                ( LIMIT_FPS * 1.5 )
#define AP_COST_MELEE_ATTACK		( LIMIT_FPS * 2 )
#define AP_COST_RANGE_ATTACK		( LIMIT_FPS * 2 )
